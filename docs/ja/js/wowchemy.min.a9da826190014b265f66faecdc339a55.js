(() => {
  ...
  (() => {
    ...
    var e = {authors: "Authors", event: "\u767B\u58C7", post: "\u6295\u7A3F", project: "\u30D7\u30ED\u30B8\u30A7\u30AF\u30C8", publication: "\u767A\u8868\u6587\u732E", slides: "Slides"}, f = {no_results: "\u7D50\u679C\u304C\u898B\u3064\u304B\u308A\u307E\u305B\u3093\u3067\u3057\u305F", placeholder: "\u691C\u7D22...", results: "results found"}, c = {indexURI: "/ooooouchi/index.json", minLength: 1, threshold: 0.3}, d = {shouldSort: true, includeMatches: true, tokenize: true, threshold: c.threshold, location: 0, distance: 100, maxPatternLength: 32, minMatchCharLength: c.minLength, keys: [{name: "title", weight: 0.99}, {name: "summary", weight: 0.6}, {name: "authors", weight: 0.5}, {name: "content", weight: 0.2}, {name: "tags", weight: 0.5}, {name: "categories", weight: 0.5}]}, a = 60;
    function g(a2) {
